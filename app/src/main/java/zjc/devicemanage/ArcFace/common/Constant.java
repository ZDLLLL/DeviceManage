package zjc.devicemanage.ArcFace.common;

public class Constant {

    public static final String APP_ID = "9yyqCqtjVFo4TJJxCzV2K5JGaiDHrxg6XCfoGkfYJSEZ";
    public static final String SDK_KEY = "BjHSvaLEytbpjSejqbEvwzr9zKZ7zXeirJjyWuX9wc5H";
